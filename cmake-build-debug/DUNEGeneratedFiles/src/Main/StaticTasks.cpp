...
DUNE::Tasks::Task* createKTHArdupilotTask(const std::string&, DUNE::Tasks::Context&);
DUNE::Tasks::Task* createKTHCMPS10Task(const std::string&, DUNE::Tasks::Context&);
DUNE::Tasks::Task* createKTHFishTask(const std::string&, DUNE::Tasks::Context&);
DUNE::Tasks::Task* createKTHISBInterfaceTask(const std::string&, DUNE::Tasks::Context&);
DUNE::Tasks::Task* createKTHTBR700Task(const std::string&, DUNE::Tasks::Context&);
...
DUNE::Tasks::Task* createSensorsSBG_ELLIPSE2DTask(const std::string&, DUNE::Tasks::Context&);
...
DUNE::Tasks::Factory::registerStaticTask("KTH.Ardupilot", createKTHArdupilotTask);
DUNE::Tasks::Factory::registerStaticTask("KTH.CMPS10", createKTHCMPS10Task);
DUNE::Tasks::Factory::registerStaticTask("KTH.Fish", createKTHFishTask);
DUNE::Tasks::Factory::registerStaticTask("KTH.ISBInterface", createKTHISBInterfaceTask);
DUNE::Tasks::Factory::registerStaticTask("KTH.TBR700", createKTHTBR700Task);
...
DUNE::Tasks::Factory::registerStaticTask("Sensors.SBG_ELLIPSE2D", createSensorsSBG_ELLIPSE2DTask);
